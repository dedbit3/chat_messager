...
public class Driver
{
    public static void addPeopleTo(Website w)
    {
        ...
        Person TA = new Person(1001,"bob","wallace");
        w.addPerson(TA);

        // Add several other people to the website.
        w.addPerson(new Person(1002,"maria","wells"));
        w.addPerson(new Person(1003,"duda","kier"));
        w.addPerson(new Person(1004,"dave","goodman"));
    }
    ...
    public static void main(String args[])
    {
        ...
        while(true)
        {
            ...
            int uid = s.nextInt();
            s.nextLine();  // c lear the carriage return
            if (uid == -1)
            {
